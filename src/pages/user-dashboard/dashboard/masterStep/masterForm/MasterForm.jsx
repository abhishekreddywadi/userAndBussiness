    ...
    <div className='master-step'>
        {showMasterForm && (
            ...
            <div className='signup-note'>
                ...
                <button type='button' onClick={() => {handleMasterGoBack()}}>Go Back</button>
                ...
                <div className='requested-form'>
                    ...
                    {showDeclinedReq && (
                        <div className='application-decline'>
                            ...
                            <button type='button' onClick={handleSubmitReqback}>Re-apply 1/3</button>
                        </div>
                    )}
